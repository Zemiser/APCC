function [VectorKStar_i, Flag, tStar] = T3BH_K_i(K_remaining,N,d,L,mu,alpha,r,tStarUB,VectorK_i_Rounding,index_r,LastK_i,Delta1,VectorKStar_i_T3)
...
minimumK_i = max(floor(VectorKStar_i_T3(index_r)) - 1,LastK_i);
maximumK_i = min(ceil(VectorKStar_i_T3(index_r)) + 1, KPrimeMax + 1);
...
%     if tStarTemp2 > tStarUB
        ...
        [VectorKStar_iTemp2, Flag, tStarTemp3] = T3BH_K_i(K_remaining - K_i,N,d,L,mu,alpha,r,tStarUB,VectorK_i_Rounding,index_r-1,K_i,Delta1,VectorKStar_i_T3);
