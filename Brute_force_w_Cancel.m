function [K_simu_opt_vec, t_simu_opt] = Brute_force_w_Cancel(K_in_vec,r,K,N,d,L,...
    mu0,alpha0,Delta,K_i_max,RepeatTimes)

% (minK_i,maxK_i,VectorK_i,index,K_remaining,DelayAPCCMinTemp,VectorK_iMinTemp,RepeatTimes,N,d,L,K,mu0,alpha0,VectorK_i_T3BH,Delta2)
% search around the value of VectorK_i_T3BH
...
for index1 = 1:Num_K_vec
    ...
    for indexRepeat = 1: RepeatTimes
        ...
        DelayAPCCTemp = ComputeEndDelay_wCancel(VectorT,r,VectorEta_i);
