function [VectorKStar_i, Flag, tStar] = T2LowerBoundK_i(K_remaining,N,d,L,mu,alpha,r,tStarUB,index_r,LastK_i,Delta1)
...
for K_i = minimumK_i:maximumK_i
    ...
    if (FlagTemp == 0) || (tStarTemp2 > tStarUB)
        ...
        [VectorKStar_iTemp2, Flag, tStarTemp3] = T2LowerBoundK_i(K_remaining - K_i,N,d,L,mu,alpha,r,tStarUB,index_r-1,K_i,Delta1);
